...
.followers-table td {
  padding: 10px;
  text-align: left;
  background-color: #2b3138; /* Sets the background for table cells */
}

.followers-table th {
  background-color: #0c1118; /* Sets background for table headers */
}
...
@media screen and (min-width: 768px) and (max-width: 1024px) {
  ...
  .followers-table th,
  .followers-table td {
    padding: 8px; /* Reducing padding to save space */
  ...
  .followers-table th,
  .followers-table td {
    width: 100%; /* Each cell takes full width on smaller screens */
...
@media screen and (max-width: 767px) {
  ...
  .followers-table {
    width: 100%;
    overflow-x: auto; /* Allows horizontal scrolling if content overflows */
    display: table; /* Use table display to maintain column layout */
  }
  ...
  .followers-table td {
    ...
    display: table-cell; /* Ensure cells are displayed side by side */
    width: 100px; /* Allow columns to adjust width automatically */
    box-sizing: border-box; /* Include padding and border in width */
  }

  .followers-table tr {
    display: table-row; /* Maintain row display to keep columns side by side */
  }
